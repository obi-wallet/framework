...
use crate::gg_2020::state_machine::sign::rounds::CompletedOfflineStageFull;
...
> {
    ...
    let offline_stages: Vec<CompletedOfflineStageFull> = simulation
        .run()
        .await
        .into_iter()
        .map(|k| k.unwrap())
